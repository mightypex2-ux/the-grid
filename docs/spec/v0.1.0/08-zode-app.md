# The Grid v0.1.0 — Zode app (standalone)
...
- **Same Zode capabilities:** Uses `zode` for libp2p, storage, proof, policy, metrics—no direct RocksDB.
